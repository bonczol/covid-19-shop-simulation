...
model_params = {
    "num_customers": UserSettableParameter("slider", "Liczba osób w sklepie", 15, 1, 30, 1),
    "sick_percent": UserSettableParameter("slider", "Procent ludzi chorych wchodzących", 0.1, 0.00, 1.0, 0.05),
    "mask_percent": UserSettableParameter("slider", "Procent ludzi noszących maseczki", 0.5, 0.00, 1.0, 0.05),
    "risk_group_percent": UserSettableParameter("slider", "Procent należących do grupy wysokiego ryzyka", 0.25, 0.00,
                                                1.0, 0.05),
    "death_ratio": UserSettableParameter("slider", "Śmiertelność dla grupy niskiego ryzyka", 0.02, 0.00, 1.0, 0.05),
    "death_ratio_rg": UserSettableParameter("slider", "Śmiertelność dla grupy wysokiego ryzyka", 0.12, 0.00, 1.0, 0.05),
    ...
    "sick_cashiers_num": UserSettableParameter("slider", "Liczba zarażonych kasjerów", 1, 0, 4, 1),
